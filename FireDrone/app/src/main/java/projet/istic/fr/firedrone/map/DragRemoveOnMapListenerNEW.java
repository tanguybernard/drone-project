 ...
 * @author Group A
 */
public class DragRemoveOnMapListenerNEW implements GoogleMap.OnMarkerDragListener {
    ...
    public DragRemoveOnMapListenerNEW(ImageButton pSuppressionMarker, GoogleMap pMap, ManagePolyline polylinesOption, MethodCallWhenDrag pCallMethodeDrag){
    ...
    public void onMarkerDragEnd(Marker marker) {
        ...
        if (overlap(markerScreenPosition, suppressionMarker)) {
            ...
            if(callMethodeDrag!=null) {
                callMethodeDrag.dragRemove(marker);
            }
        }else{
            if(polylineManager != null) {
