...
public class InterventionController {
    ...
    public Intervention insertIntervention(@RequestBody Intervention intervention){
    ...
    public List<Way> addWayToIntervention(@PathVariable String id, @RequestBody Way way) {
    ...
    public List<Way> updateWayToIntervention(@PathVariable String id, @RequestBody Way way) {
    ...
    public void deleteWayIntervention(@PathVariable String id, @PathVariable String idWay) {
